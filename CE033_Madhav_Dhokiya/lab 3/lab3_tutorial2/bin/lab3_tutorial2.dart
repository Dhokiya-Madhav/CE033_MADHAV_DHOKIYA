...
/* 
  ...
  print(getMultipleArgument("Madhav", "Dhokiya"));

  //Output:
  // Hello Madhav, Dhokiya
...
/*  
  ...
  print(getFullName("Madhav", "Dhokiya"));
  print(getFullName("Madhav", "Dhokiya", "Hello User"));
...
/* 
  ...
  print(getFullName("Madhav", "Dhokiya"));
  print(getFullName("Madhav", "Dhokiya", "Hi,"));
...
/*  
  ...
  print(greetingsNamed(name: "Madhav"));
  ...
  print(greetingsNamedRequired(name: "Madhav"));
...
/* 
  ...
  /// It will take Madhav as argument and name variable will consider as String variables.
